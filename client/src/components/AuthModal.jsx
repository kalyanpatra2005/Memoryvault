            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  <input
                    type="text"
                    required
                    placeholder="e.g. user@vault.com or 8653429085"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    type="text"
                    required
                    placeholder="Your registered name (e.g. Kalyan Patra)"
                    value={loginName}
              ...
              <div className="pt-2 text-center">
                <button
                  type="button"
                  onClick={() => setIsSyncOpen(true)}
                  className="inline-flex items-center space-x-1.5 text-xs text-amber-400 hover:text-amber-200 underline transition"
                >
                  <Smartphone className="w-3.5 h-3.5" />
                  <span>First time on this laptop? Sync from Mobile</span>
                </button>
              </div>
            </form>
          ) : (
