      ...
      <div className="w-full max-w-md mx-auto px-5 sm:px-8 py-4 flex-1 flex flex-col justify-center">
        ...
        <div className="text-center mb-6">
          ...
          <p className="mt-1.5 text-xs sm:text-sm text-stone-500 dark:text-stone-400">
            Start your personal memory book
          </p>
        </div>
        ...
        <div className="sm:bg-paper-50 sm:dark:bg-stone-900 sm:p-8 sm:rounded-3xl sm:shadow-lg sm:border sm:border-stone-200/90 sm:dark:border-stone-800">
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            {/* Name */}
            <div>
              <label className="block text-xs font-bold uppercase tracking-wider text-stone-600 dark:text-stone-300 mb-1 font-sans">
                Your Name
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 text-base bg-white dark:bg-stone-800/90 border border-stone-200 dark:border-stone-700 rounded-2xl text-stone-900 dark:text-stone-100 placeholder-stone-400 focus:outline-none focus:ring-2 focus:ring-amber-500/40 focus:border-amber-600 transition shadow-sm"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-12 py-3 text-base bg-white dark:bg-stone-800/90 border border-stone-200 dark:border-stone-700 rounded-2xl text-stone-900 dark:text-stone-100 focus:outline-none focus:ring-2 focus:ring-amber-500/40 focus:border-amber-600 transition shadow-sm"
                />
                <button
                  type="button"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 text-base bg-white dark:bg-stone-800/90 border border-stone-200 dark:border-stone-700 rounded-2xl text-stone-900 dark:text-stone-100 focus:outline-none focus:ring-2 focus:ring-amber-500/40 focus:border-amber-600 transition shadow-sm"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full min-h-[50px] py-3.5 px-6 bg-gradient-to-r from-amber-800 to-amber-700 hover:from-amber-900 hover:to-amber-800 active:scale-[0.99] text-white font-semibold rounded-2xl text-base shadow-md transition flex items-center justify-center gap-2 mt-3"
            >
